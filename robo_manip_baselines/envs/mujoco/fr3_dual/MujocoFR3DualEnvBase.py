...
class MujocoFR3DualEnvBase(MujocoEnvBase):
        ...
        self.body_config_list = [
            ArmConfig(
                arm_urdf_path=path.join(
                    path.dirname(__file__), "../../assets/common/robots/fr3/fairino3_v6.urdf"
                ),
                arm_root_pose=self.get_body_pose("left/fr3_root_frame"),
                ik_eef_joint_id=6,
            ...
            ArmConfig(
                ...
                arm_root_pose=self.get_body_pose("right/fr3_root_frame"),
                ik_eef_joint_id=6,
